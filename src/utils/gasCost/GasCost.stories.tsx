...
stories.add('Gas cost states', () => (
  <div>
    <table>
      <thead>
        <tr>
          <th style={thStyle}>Gas estimation status</th>
          <th style={thStyle}>GasCost</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td style={tdStyle}>
            <GasCost gasEstimationStatus={GasEstimationStatus.unset} />
          </td>
        </tr>
        <tr>
          <td style={tdStyle}>calculating</td>
          <td style={tdStyle}>
            <GasCost gasEstimationStatus={GasEstimationStatus.calculating} />
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style={tdStyle}>
            <GasCost gasEstimationStatus={GasEstimationStatus.error} />
          </td>
        </tr>
      </tbody>
    </table>
