...
const SampleRow = ({ value, token }: { value: number; token: string }) => (
  <tr>
    ...
    <td style={{ padding: '2px 10px', textAlign: 'right' }}>{formatAmount(new BigNumber(value), token)}</td>
    <td style={{ padding: '2px 10px', textAlign: 'right' }}>
...
stories.add('Number formatter', () => (
  <table>
    <thead>
      <tr>
        <th style={{ fontSize: 'smaller', color: '#aaa', padding: '0 10px', textAlign: 'right' }}>Original value</th>
        <th style={{ fontSize: 'smaller', color: '#aaa', padding: '0 10px', textAlign: 'right' }}>formatAmount()</th>
        ...
        <th style={{ fontSize: 'smaller', color: '#aaa', padding: '0 10px', textAlign: 'right' }}>
          FormatAmount
          <br />
          greyedNonSignZeros=true
        </th>
        <th style={{ fontSize: 'smaller', color: '#aaa', padding: '0 10px', textAlign: 'right' }}>Money component</th>
        <th style={{ fontSize: 'smaller', color: '#aaa', padding: '0 10px', textAlign: 'right' }}>
          Money component
          <br />
          greyedNonSignZeros=true
