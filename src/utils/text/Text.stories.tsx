    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td>InfoLabel</td>
          <td>
            <InfoLabel>Sample text</InfoLabel>
          </td>
        </tr>
        <tr>
          <td>Muted</td>
          <td>
            <Muted>Sample text</Muted>
          </td>
        </tr>
        <tr>
          <td>RedSpan</td>
        ...
        <tr>
          <td>GreenSpan</td>
          <td>
            <GreenSpan>Sample text</GreenSpan>
          </td>
        </tr>
        <tr>
          <td>SellBuySpan type: sell</td>
          <td>
            <SellBuySpan type="sell">Sample text</SellBuySpan>
          </td>
        </tr>
        <tr>
          <td>SellBuySpan type: buy</td>
          <td>
            <SellBuySpan type="buy">Sample text</SellBuySpan>
          </td>
        </tr>
        <tr>
          <td>SellBuySpan type: default</td>
          <td>
            <SellBuySpan type="">Sample text</SellBuySpan>
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <div>
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            middleAs - optional; by default 'neutral' - it determines color for middle value; possible values:
            <ul>
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td colSpan={5}>
              <InfoLabel>Default values</InfoLabel>
            </td>
          </tr>
          <BoundaryRow value={-3} />
          <BoundaryRow value={0} />
          ...
          <tr>
            <td colSpan={5}>
              <InfoLabel>MiddleValue -2</InfoLabel>
            </td>
          </tr>
          ...
          <tr>
            <td colSpan={5}>
              <InfoLabel>Different middleAs</InfoLabel>
            </td>
          </tr>
