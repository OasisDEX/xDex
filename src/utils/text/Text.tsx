...
export const InfoLabel = ({ children, className, ...props }: { children: any; className?: string } | any) => (
  <span className={classnames({ [styles.infoLabel]: true, [className]: className })} {...props}>
    {children}
  </span>
)

export const Muted = ({ children, className, ...props }: { children: any; className?: string } | any) => (
  <span className={classnames({ [styles.muted]: true, [className]: className })} {...props}>
    {children}
  </span>
)

export const RedSpan = ({ children, className }: { children: any; className?: any }) => (
  <span className={classnames({ [styles.redSpan]: true, [className]: className })}>{children}</span>
)

export const GreenSpan = ({ children, className }: { children: any; className?: any }) => (
  <span className={classnames({ [styles.greenSpan]: true, [className]: className })}>{children}</span>
)
...
export const Currency = ({
  ...
  <span data-test-id="currency" className={classnames(styles.currency, theme)}>
    {value}
  </span>
)
