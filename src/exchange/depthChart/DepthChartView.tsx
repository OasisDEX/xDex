    ...
    <>
      <PanelHeader bordered={true}>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex' }}>
          <Button style={btnStyles} onClick={zoomOut} disabled={!data.zoomOutEnabled}>
            <SvgImage image={minusSvg} />
          </Button>
          <Button style={btnStyles} onClick={zoomIn} disabled={!data.zoomInEnabled}>
      ...
      <div className={styles.depthChart}>
        ...
        {data.summary && drawSummaryInfoBox(data.summary) && (
          <Legend summary={data.summary} fromCurrency={props.base || ''} toCurrency={props.quote || ''} />
        )}
      </div>
    </>
  );
