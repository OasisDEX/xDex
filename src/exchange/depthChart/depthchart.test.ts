...
test('0.1. Default - base data when no price nor amount given', () => {
  const dcd = dc.getDepthChartData(fakeOrderbook.buy, fakeOrderbook.sell, OfferType.sell, OfferMatchType.limitOrder)
...
test('0.2. Default - base data very asymmetric', () => {
  ...
  const dcd = dc.getDepthChartData(
    asymmetricOrderbook.buy,
    asymmetricOrderbook.sell,
    OfferType.sell,
