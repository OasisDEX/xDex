...
defaultStories.add('Different zooms', () => {
  return (
    <div>
      ...
      <DepthChartView {...defChartProps} orderbook={fakeOrderBook} kind={OfferType.buy} />
      <h4>Zoom 5</h4>
      <DepthChartView {...defChartProps} zoom={new BigNumber(5)} orderbook={fakeOrderBook} kind={OfferType.buy} />
      <h4>Zoom 10</h4>
      <DepthChartView {...defChartProps} zoom={new BigNumber(10)} orderbook={fakeOrderBook} kind={OfferType.buy} />
      <h4>Zoom 50</h4>
      <DepthChartView {...defChartProps} zoom={new BigNumber(50)} orderbook={fakeOrderBook} kind={OfferType.buy} />
      <h4>Zoom 100</h4>
      <DepthChartView {...defChartProps} zoom={new BigNumber(100)} orderbook={fakeOrderBook} kind={OfferType.buy} />
      <h4>Zoom 500</h4>
...
limitOrderStories.add(
  `Buy a bit with price lower than anyone's - it changes buy, extends x axis on the left` + ' (p: 100, a: 100)',
  () => (
    <DepthChartView
      {...defChartProps}
