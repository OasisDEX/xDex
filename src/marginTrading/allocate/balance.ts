...
export function balance(
  ...
  console.log('rounding correction', targetDebt.toString(), tabsTotalRounded.toString(), roundingCorrection.toString())
...
export function do_example_with_2() {
  ...
  gems.forEach((gem, i) => {
    ...
    console.log(
      `(collateral ratio=${(inks[i] * tags[i]) / tabs[i]}, liquidation probability=${liquidationProbability(
        inks[i],
        tabs[i],
        tags[i],
        mats[i],
  ...
  gems.forEach((gem, i) => {
    ...
    console.log(
      `(collateral ratio=${(inks[i] * tags[i]) / tabs2[i]}, liquidation probability=${liquidationProbability(
        inks[i],
        tabs2[i],
        tags[i],
        mats[i],
