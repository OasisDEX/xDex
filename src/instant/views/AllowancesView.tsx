        ...
        <span className={styles.indicator}>
          {inProgress ? (
            ...
            <SvgImage
              ...
              className={isAllowed ? styles.isAllowed : styles.disabled}
              image={doneSvg}
            />
          )}
        </span>
  ...
  public render() {
    ...
    return (
      <InstantFormWrapper heading={'Unlock Token'}>
        <TopRightCorner>
          <CloseButton theme="danger" data-test-id="close" onClick={this.close} />
        </TopRightCorner>
        <div className={styles.assets}>
          {tradingTokens
            ...
            .map((token: any, index: number) => {
              ...
              return (
                <AssetAllowance
                  isAllowed={allowances ? allowances[token] : false}
