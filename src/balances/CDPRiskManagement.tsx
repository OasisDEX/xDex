...
export class CDPRiskManagement extends React.Component<MarginableAsset & ModalOpenerProps> {
  public render() {
    return (
      <Panel style={{ width: '100%' }}>
        ...
        <div className={styles.panelBody}>
          ...
          {this.props.liquidationInProgress && <div style={{ textAlign: 'center' }}>liquidation in progress!</div>}
          {this.props.safe !== undefined && (
            <div style={{ textAlign: 'center' }}>safe: {this.props.safe ? 'true' : 'false'}</div>
          )}
    ...
    return (
      <div className={styles.box}>
        ...
        <div className={styles.detailedRow}>
          ...
          <Money value={this.props.availableBalance} token={this.props.name} className={styles.detailedMoney} />
        </div>
        <div className={styles.detailedRow}>
          <Muted>Locked</Muted>
          <Money value={this.props.lockedBalance} token={this.props.name} className={styles.detailedMoney} />
        </div>
        <div className={styles.detailedRow}>
          <Muted>Total</Muted>
      ...
      <div className={styles.box}>
        ...
        <div className={styles.detailedRow}>
          ...
          {this.props.currentCollRatio && (
            <FormatPercent
              value={this.props.currentCollRatio}
              multiply={true}
        ...
        <div className={styles.detailedRow}>
          <Muted>Safe</Muted>
          <FormatPercent value={this.props.safeCollRatio} multiply={true} className={styles.detailedPercent} />
        </div>
        <div className={styles.detailedRow}>
          <Muted>Minimum</Muted>
  ...
  private debt() {
    return (
      <div className={styles.box}>
        ...
        <div className={styles.detailedRow}>
          <Muted>Available</Muted>
          <Money value={this.props.availableDebt} token="DAI" className={styles.detailedMoney} />
        </div>
        <div className={styles.detailedRow}>
          <Muted>Locked</Muted>
          <Money value={this.props.debt} token="DAI" className={styles.detailedMoney} />
        </div>
        <div className={styles.detailedRow}>
          <Muted>Max</Muted>
